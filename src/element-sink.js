...
const {Elements, ElementsBuilder, ValueElement, FragmentsElement, FragmentElement, SequenceElement,
    SequenceDelimitationElement, ItemElement, ItemDelimitationElement, Sequence, Item, Fragment,
    Fragments} = require("./elements");
