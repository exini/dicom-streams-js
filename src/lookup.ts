import Tag from "./tag";
import * as tagToVR from "./tag-to-vr";
import { VR } from "./vr";

// tslint:disable: no-bitwise

export const keywords = Object.keys(Tag);

export function keywordOf(tag: number): string {
...
export function vrOf(tag: number): VR {
    return tagToVR.vrOf(tag);
}
export function tagOf(keyword: string): number {
